...
(async function main() {
  ...
  init(
    document.getElementById('lce-container')!,
    {
      ...
      simulatorUrl: [
        'https://alifd.alicdn.com/npm/@alilc/lowcode-react-simulator-renderer@1.1.7/dist/css/react-simulator-renderer.css',
        'https://alifd.alicdn.com/npm/@alilc/lowcode-react-simulator-renderer@1.1.7/dist/js/react-simulator-renderer.js',
      ],
      requestHandlersMap: {
